...
1. Read `results/$1/flows/<flow-id>/$2/step3-extract-selectors/normalized-selectors.md`.
2. Read `results/$1/flows/<flow-id>/$2/step1-resolve/flow-inventory.json` to understand the selected flow and start path.
...
7. Write the draft to `results/$1/flows/<flow-id>/$2/step4-draft-page-object/page-object.draft.ts`.
