...
1. Load and validate `apps/$1/profile.yaml` (in the worktree)
2. Read the profile's `baseUrlEnvVar` field and check that env var is set in `.env` (the worktree has a .env copy)
